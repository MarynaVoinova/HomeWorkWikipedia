...
public class SearchPageObject extends MainPageObject
{
    private static final String
        ...
        SEARCH_RESULT_LIST_ITEM = "org.wikipedia:id/page_list_item_title";
    ...
    public void waitForSearchResult(String substring)
    {
        ...
        this.waitForElementPresent(By.xpath(searchResult_xPath), "Cannot find search result with substring: " + substring);
    }

    public void clickByArticleWithSubstring(String substring)
    {
        String searchResult_xPath = getResultSearchElement(substring);
        this.waitForElementAndClick(By.xpath(searchResult_xPath), "Cannot find  and click search result with substring: " + substring, 10);
    }
